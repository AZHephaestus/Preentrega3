...
urlpatterns = [
    ...
    path('gamebygenre/update/<int:pk>', GameByGenreUpdate.as_view(), name= "gamebygenre_update"),
    ...
    path('gamebygenre/delete/<int:pk>', GameByGenreDelete.as_view(), name= "gamebygenre_delete"),
    ...
    #path('game/purchase/', GamePurchase.as_view(), name= "game_purchase"),
]
